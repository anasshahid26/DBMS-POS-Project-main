...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Herbal Inventory</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    $sql = "SELECT name FROM `items_type` where item_tp_id='40' ORDER BY `items_type`.`name` ASC";
    $res = mysql_query($sql);
...
$sql1="SELECT * FROM `items_type` where name='$item_name' and item_tp_desc='HERBAL'";
...
{	
 ...
 mysql_query("INSERT INTO `customer_inventory` VALUES ('$ID','','$datee','HERBAL','$item_name','$formula','$Power','$quantity','$unit_pricee','$total_price')");

echo "succefully enter";
mysql_query("UPDATE `items_type` SET `quantity`=quantity-$quantity WHERE item_tp_id='40' and name='$item_name'");
echo "succefully enter";
}
else
{
