...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("Custom-Icon-Design-Pretty-Office-4-ICO.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("Custom-Icon-Design-Pretty-Office-4-ICO.ico") ?>">
