...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add General Items</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Batch Number">
                                        </div>
                                        <div class="form-group">
                                            <label>Formula</label>
                                            <input class="form-control" placeholder="Formula">
                                        </div>
                                ...
                                <div class="col-lg-6 padd_new">
                                     <div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Manufacturer Date">
                                        </div>	
										<div class="form-group">
