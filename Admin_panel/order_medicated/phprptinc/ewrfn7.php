...
function CurrentProjectID() {
	...
	return "{21161F12-4D6F-499A-AD2E-5B9C37B92793}";
}
...
function ewr_SendEmail($sFrEmail, $sToEmail, $sCcEmail, $sBccEmail, $sSubject, $sMail, $sFormat, $sCharset, $sSmtpSecure = "", $arAttachments = array(), $arImages = array()) {
...
function ewr_TmpImageLnk($file, $lnktype = "") {
	...
	if ($lnktype == "email" || $lnktype == "cid") {
		...
		return ewr_UploadPathEx(FALSE, EWR_UPLOAD_DEST_PATH) . $file;
	}
}
?>
<?php
