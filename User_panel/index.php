...
session_start();
$check=$_SESSION['user_name'];
$session=mysql_query("SELECT user_name FROM `admin` WHERE user_name='$check' ");
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#"><i class="fa fa-th-list fa-fw"></i>Items<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-indent fa-fw"></i>Add Items<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
						...
						<li>
                            <a href="#"><i class="fa fa-money fa-fw"></i>Sales Order<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
						...
						<li>
                            <a href="#"><i class="fa fa-shopping-cart fa-fw"></i>Customer Inventory<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
